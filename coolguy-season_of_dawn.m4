title:Coolguy - Season of Dawn
//description: see https://www.youtube.com/channel/UCAOitB3h99Ur9RzR5ftd2bA

//notes:Coolguy - PvE
Martyr_s_Retribution(
  Field_Prep, Demolitionist|Lead_from_Gold
)

//notes:Coolguy - PvP. use quick access sling mod, fire grenade then switch to primary
Martyr_s_Retribution(
  Auto_Loading_Holster
)

//notes:Coolguy - PvE, unique perk
Line_In_The_Sand(
  Rapid_Hit, Firing_Line|Clown_Cartridge
)

//notes:Coolguy - PvP, Controller. needs Counter Balance mod
Infinite_Paths_8(
...
Patron_of_Lost_Causes(
  Rapid_Hit, Vorpal_Weapon|Explosive_Payload
)

//notes:Coolguy - PvE. use with Boss Spec or Major Spec mod
Traveler_s_Judgment_5(
  Auto_Loading_Holster|Rapid_Hit, Disruption_Break
)

//notes:Coolguy - PvP.
Traveler_s_Judgment_5(
  Rapid_Hit, Tap_the_Trigger
)
